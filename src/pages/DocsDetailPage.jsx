...
const guides = {
  ...
  "brand-guide": {
    ...
    related: [
      ...
      ["제품 디자인 가이드", "/docs/design-guide"],
      ["서비스 이용제한 정책", "/service-restrictions"],
    ],
  },
  "design-guide": {
    eyebrow: "제품 디자인",
    title: "Cokform 제품 디자인 가이드",
    description: "웹·모바일 폼 편집기와 응답 화면을 일관되게 만들기 위한 컴포넌트·상태·반응형 기준입니다.",
    icon: Palette,
    sections: [
      {
        id: "principles",
        title: "제품 원칙",
        checks: [
          "질문과 입력을 장식보다 먼저 보여줍니다.",
          "한 화면의 대표 행동은 하나만 진하게 강조합니다.",
          "저장·복구·오류·마감 상태를 짧은 문장과 아이콘으로 함께 알립니다.",
          "색상만으로 필수·오류·문항 유형을 구분하지 않습니다.",
          "모바일 390px에서 가로 스크롤 없이 읽고 입력할 수 있어야 합니다.",
        ],
      },
      {
        id: "tokens",
        ...
        table: {
          headers: ["영역", "기준", "사용"],
          rows: [
            ["색상", "Ink #17251F · Deep Green #0F5B46 · Green #17866D", "본문·주요 버튼·상호작용"],
            ["표면", "Warm White #FFFDF8 · Canvas #F5F3EC", "카드·페이지 배경"],
            ["글꼴", "Pretendard 계열", "제목·본문·숫자까지 통일"],
            ["간격", "4px 단위, 주요 간격 8·12·16·24·32px", "레이아웃·카드·입력"],
            ["카드", "1px 경계·일관된 radius·낮은 그림자", "정보 그룹화"],
          ],
        },
      },
      {
        ...
        title: "컴포넌트 상태",
        table: {
          headers: ["컴포넌트", "기본 규칙", "금지"],
          rows: [
            ["버튼", "대표 행동은 Deep Green, 보조 행동은 경계·텍스트", "hover에서 위치·크기 이동"],
            ["입력", "라벨·필수 여부·힌트·오류를 입력 영역과 함께 표시", "placeholder만으로 질문·필수 여부 전달"],
            ["카드", "제목·설명·대표 행동의 순서를 유지", "클릭하지 않는 카드에 hover 효과"],
            ["상태", "무슨 일이 일어났고 무엇을 할지 한 줄로 설명", "토스트만으로 중요한 오류 전달"],
          ],
        },
      },
      {
        ...
        title: "모바일과 접근성",
        paragraphs: [
          "모바일에서는 단일 열을 기본으로 하고, 버튼의 실질적인 터치 영역을 충분히 확보합니다. 긴 테이블과 코드만 내부 스크롤을 허용하며 페이지 전체의 가로 넘침은 허용하지 않습니다.",
          "일반 텍스트는 최소 4.5:1 대비를 목표로 하며, 포커스 링을 제거하지 않습니다. 키보드 순서는 시각적 순서와 맞추고, 오류와 필수 상태는 색상 외에 문장과 의미 있는 HTML 속성으로 전달합니다.",
        ],
      },
      {
        id: "qa",
        title: "배포 전 QA",
        checks: [
          "질문 제목을 클릭해 편집할 수 있고 Enter 줄바꿈이 유지됩니다.",
          "새로고침 후 편집 중인 폼과 응답자 초안이 사라지지 않습니다.",
          "조건부 질문은 선택한 팀에 맞는 문항만 표시하고 숨겨진 값은 제출하지 않습니다.",
          "삭제·마감·초기화에는 확인 또는 복구 경로가 있습니다.",
          "390px 모바일과 데스크톱에서 카드·버튼·텍스트가 겹치지 않습니다.",
        ],
        links: [["브랜드 가이드 보기", "/docs/brand-guide"], ["브랜드 리소스 센터", "/resources"]],
      },
    ],
    related: [
      ["브랜드 가이드", "/docs/brand-guide"],
      ["폼 만들기와 공유", "/docs/create-and-share"],
      ["문제 해결", "/docs/troubleshooting"],
    ],
  },
